define({ "api": [
  {
    ...
    "error": {
      "examples": [
        ...
        {
          "title": "Error-Response:",
          "content": "404 잘못된 이모지 번호\n{\n \"status\": 404,\n \"message\": \"잘못된 이모지 id입니다.\"\n}",
          "type": "json"
        },
        {
          "title": "Error-Response:",
          "content": "404 이미 피드에 붙여져 있는 이모지\n{\n \"status\": 404,\n \"message\": \"이미 추가된 이모지입니다.\"\n}",
          "type": "json"
        },
        {
          "title": "Error-Response:",
          "content": "405 존재하지 않는 피드\n{\n \"status\": 405,\n \"message\": \"피드가 존재하지 않습니다.\"\n}",
          "type": "json"
        },
        {
          "title": "Error-Response:",
