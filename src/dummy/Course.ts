...
export const courses = [
  ...
  new Course(15, 3, "일찍 일어나는 새", "일찍 일어나는 새가 벌레를 잡는다는 말도 있잖아?나와 함께 모닝 루틴을 수행하면서 건강한 아침 습관을 만들어보자구.", 7, 20, [
    new Challenge(1, "잠자리 정리하기", "일어나자마자 이불 정리하는 거 생각보다 귀찮지? 그치만 하고 나면 얼마나 뿌듯한데! 얼른 이불 정리부터 해보자.", "어때? 하고 나니 뿌듯하지? 앞으로 매일 일어나자마자 이불 정리부터 해보자!", 20),
    new Challenge(2, "양치 후 물 한 컵", "일어나자마자 물 먹기는 금물. 양치 한 후에 물을 먹어야 된대! 양치 후에 미지근한 물 한 컵으로 뇌를 깨워보자구.", "잠자리 정리한 후 양치한 다음 물 한 컵! 상상만 해도 상쾌한 걸?", 20),
    new Challenge(3, "아침 산책하기", "정리, 양치.. 그 다음엔 산책을 해보자. 꼭 산책이 아니어도 좋으니 ㅁㅁㅁ만의 루틴으로 몸을 깨워보자!", "새가 지저귀는 소리, 선선한 아침 공기. 전부 일찍 일어난 자만 느낄 수 있는 특권이라구.", 20),
    new Challenge(4, "내 취미 생활하기", "남들보다 일찍 시작하는 하루, 좋아하는 취미를 할 수 있는 시간이 생겼어. ㅁㅁㅁ만의 취미 생활을 즐겨봐!", "어떤 걸 했어? 외국어 공부? 독서? 뭐가 됐든 행복했다면 됐어~", 20),
    new Challenge(5, "나를 위한 응원의 한 마디", "오늘 하루도 고생할 나를 위해 응원의 한 마디 해주는 거 어때? ㅁㅁㅁ, 오늘도 화이팅!", "나 자신이야 말로 누구보다 든든한 내 편이란 거 알고 있지? 물론 나도 항상 널 응원하고 있다는 거 잊지마~!", 20),
    new Challenge(6, "오늘 할 일 적기", "아직도 아침이라니! 오늘은 어떤 일이 기다리고 있을까? 거창하지 않아도 좋아. 오늘 할 일을 적고 체크해나가며 뿌듯함을 느껴보자!", "하나 하나 체크할 때 마다 얼마나 뿌듯한 지 몰라. 앞으로도 계획적으로 살아보자구~", 20),
    new Challenge(7, "모든 루틴 수행하기", "기억 하지? 잠자리 정리, 양치 후 물 한 컵, 운동, 취미 생활, 응원, 할 일 적기! 오늘은 전부 해보는 건 어때?", "일주일동안 성공적으로 코스를 수행했구나! 어때? 벌레는 많이 잡았어? 앞으로도 ㅁㅁㅁ만의 모닝 루틴을 만들어보자!", 20)
  ]),
  new Course(16, 5, "갤러리 여행 떠나기", "갤러리에서 추억 여행을 떠나보는 코스", 7, 20, [
    new Challenge(1, "1년전 내모습 찾아보기", "작년의 나는 어땠을까? 갤러리에서 1년전 나를 찾아보자! 어떤 사람들과 만났고 추억을 쌓았는지 알 수 있을거야~", "추억을 떠올리며 본 작년 모습은 어때? 작년에도 지금도 여전히 너는 최고야!", 20),
    new Challenge(2, "가족들 사진 찾아보기", "갤러리에서 우리 가족들 사진을 찾아보자! 어디에서 어떤 일들이 있었는지 회상도 해보면 좋을거야~", "가족들 사진을 보니 어때? 현실이 바쁘더라도 가족들과 추억을 많이 남겨보자~", 20),
    new Challenge(3, "웃는 얼굴 사진 찾아보기", "히히~ 갤러리에서 나의 웃는 얼굴을 찾아보는거야! 어떤 추억이 나올까 궁금하지 않아?", "웃는 모습을 보니 다시 그 감정이 떠올라 행복해지지 않았어? 사진처럼 앞으로도 웃는 일이 많이 생길거야!", 20),
    new Challenge(4, "음식 사진 찾아보기", "아이 배고파.. 갤러리에서 맛있는 음식 사진을 찾아보자! 함께한 사람과의 추억도 자연스레 떠오를거야~", "그동안 먹은 맛있는 음식들을 보고 왔어? 이렇게 맛있는 음식을 많이 먹었다니 ㅁㅁㅁ는 행복한 사람이야~", 20),
    new Challenge(5, "멋진 풍경 사진 찾아보기", "여행지 사진, 멋지게 자라있는 나무, 노을 지는 집 앞 풍경 등 멋진 풍경 사진을 찾아보자~", "멋진 풍경을 보니.. 여행 떠나고 싶다.. 하지만 우리는 추억 여행을 떠나고 왔는걸! 여행은 멀리 있지 않다구~", 20),
    new Challenge(6, "하늘 사진 찾아보기", "새파란 하늘, 재미있게 생긴 구름을 보면 사진을 꼭 찍게 되더라.. 어떤 사진을 찍었는지 한번 갤러리에서 찾아보자!", "매일 보는 하늘인데 사진으로 보니 색다르고 더 예쁘지 않아? 하늘 사진을 보면서 기분이 좋아졌으면 좋겠어~", 20),
    new Challenge(7, "가장 오래된 사진 찾아보기", "갤러리에 있는 가장 오래된 사진은 무엇일까? 어릴 때의 모습? 친구들 사진? 너무 궁금하다!", "갤러리의 가장 끝 과거까지 여행해보니 여러 추억들이 모두 생각나지 않아? 지금까지 여행하느라 수고했어!", 20)
  ]),
  new Course(17, 1, "긍정의 아이콘", "건강한 마음은 긍정적인 생각에서부터 시작돼!3일 후면 긍정의 아이콘이 되어있을 거야.", 3, 20, [
    new Challenge(1, "감사일기 쓰기", "오늘 하루 감사한 일 3가지만 딱 적어보자!아주 사소한 것이라도 좋아~", "감사함을 느끼는 것은 행복감을 가져오고,자존감을 높여준대!", 20),
    new Challenge(2, "내가 좋아하는 것 적어보기", "좋아하는 것들을 적어보자!간단한 일도 괜찮아!", "기쁨을 가져다 주는 일을 위해서 하루 중 약간의 시간을 써보자!", 20),
    new Challenge(3, "내 긍정적인 특징 적어보기", "우리 이 특징들을 마음에 새기자. 하루에 한 번씩은 읽어볼까?", "내가 하나 더 추가해 줄게.'ㅁㅁㅁ! 매일 모든 면에서 점점 좋아지고 있다.'", 20)
  ]),
  new Course(18, 7, "나 제법 똑똑해", "똑똑하고 섹시한 뇌를 가지고 싶어? 나만 믿고 일주일만 따라해봐. 일주일 후엔 몸도 마음도 똑똑이가 되어있을거야", 7, 20, [
    new Challenge(1, "일어나서 시사 뉴스 읽기", "굿모닝! 잠은 잘 잤어? 하루를 시작하기 전에 시사 뉴스를 읽어보며 뇌를 말랑하게 해보자!", "어때 쉽지? 말랑해진 뇌로 오늘 하루를 더욱 알차게 보내길 바라 !", 20),
    new Challenge(2, "관심있는 분야 TED 강연 듣기", "똑똑! 지금 머릿속에 스치는 키워드가 뭐야? 최근에 생긴 관심사나 커리어는? 그 분야에 종사하는 사람의 강연을 들어봐", "조금이라도 관심이 생긴 분야에 가까워진 느낌이 들지? 그럼 주저하지 말고 도전해봐 !", 20),
    new Challenge(3, "아침에 일어나서 뉴스레터, 신문 읽기", "안녕? 오늘은 sns부터 들어가지말고 어젯밤 무슨 일들이 있었는지 신문이나 뉴스 헤드라인을 읽어보자", "어젯밤에는 어떤 일들이 있었는지 잘 살펴봤어? SNS에 접속하는 시간을 조금씩 줄여보자", 20),
    new Challenge(4, "외국어 원서 아티클 읽고 정리하기", "헬로! 니하우! 봉주르! 오늘은 공부하고 싶은 외국어를 하나 정해서 해당 언어로 쓰여진 원서를 읽어볼까 ?", "알럽유! 워아이니! 즈뗌므! 간단한 외국어라도 알아두면 언젠가 도움이 될거야, 똑똑해진 널 사랑해 !", 20),
    new Challenge(5, "잠자기 전 나를 위한 독서 시간 갖기", "냠냠, 독서는 마음의 양식이라고! 오늘 밤에는 야식말고 마음의 양식 독서를 해보는게 어때? 배고픔이 사라질걸", "마음의 멘탈 푸드 맛있게 먹고 왔어? 똑똑해지는 다음 단계로 암온더넥스트레블 ! 가보자고!", 20),
    new Challenge(6, "책 읽고 마음에 두는 한줄을 찾아 메모해두기", "너의 마음을 보듬어 줄 수 있는 책 속의 한 구절을 수첩에 메모해보자. 기운이 빠질 때 한 번씩 들여다볼 수 있게", "소중한 너에게 한 줄기의 빛이 되어줄 구절을 앞으로도 자주 기록하고, 들여다보길 바라.", 20),
    new Challenge(7, "오직 나를 위한 취미 생활 만들기", "너의 온전한 시간을 갖으면서 취미 생활을 즐겨보자 ! 스트레스를 잘 푸는 방법도 중요하다고", "매일 반복되는 일상에 하루정도는 너에게 온전히 집중하고 투자하는 시간을 가져봐 !", 20)
  ]),
  new Course(19, 2, "내가 제일 잘 나가", "자기 자신을 더 잘 알게되면서 자존감을 높이는 코스", 3, 20, [
    new Challenge(1, "오늘의 나한테 칭찬해주기", "오늘의 ㅁㅁㅁ! 아주 자랑스럽지 않아?? 어떤 주제든 좋으니까 칭찬 한마디 해주자!", "아주 잘했어. 나는 오늘의 ㅁㅁㅁ도, 내일의 ㅁㅁㅁ도 아주 자랑스러워! 내 곁에 있어줘서 고마워 ㅁㅁㅁ~", 20),
    new Challenge(2, "일어난 후에 명상 10분 이상 하기", "명상하는 것은 너 자신을 더 알 수 있게 해준대! 나랑 같이 동영상 보면서 명상 해보자!", "와.. 나 잠깐 졸 뻔 했어! 처음이라서 아직 졸렸지만 꾸준히 하면 확실히 마음이 편안해질 것 같아! ㅁㅁㅁ, 너는 어땠어?", 20),
    new Challenge(3, "요즘 고민에 대해 종이에 마구 적어보기", "ㅁㅁㅁ! 요즘 고민 있지~? 종이에 막 써내려가면서 생각 정리하면 고민이 너무 무겁게만 느껴지진 않을거야!", "어때, 좀 정리가 됐어?! 어어 나 갑자기 막 촉이와! ㅁㅁㅁ 고민이 해결될 것 같다는 촉!", 20)
  ]),
  new Course(20, 1, "눈은 소중하니까", "우리의 눈은 소중하니까! 휴대폰, 컴퓨터 많이 보고 피로해진 눈에 휴식을 줄 수 있는 코스", 7, 20, [
    new Challenge(1, "1분동안 눈 감고 있기", "흑흑.. 눈이 너무 피곤하대 하루종일 열심히 일하는 눈을 위해 잠시 휴식을 주자!", "눈이 힘을 얻었다! 이제 다시 열심히 일할 수 있대~ 가끔씩 눈에게도 휴식을 주자", 20),
    new Challenge(2, "1분동안 먼 곳 바라보기", "저기저 먼곳에는 무엇이 있을까... 매번 가까이 있는 것만 보지 말고 저 먼 곳을 바라보며 눈의 피로를 풀어보자!", "해보니 어때? 멀리있는 풍경을 보니 그동안 보지 못했던 것들도 보이는 느낌이야!", 20),
    new Challenge(3, "눈동자 원으로 세번 굴리기", "데굴데굴~ 동그라미를 그리면서 눈 운동을 해보자! 분명 눈도 운동을 좋아할걸?", "데굴데굴~ 눈운동 너무 쉽지않아? 앞으로도 가끔씩 동글동글 눈동자 굴려보자~", 20),
    new Challenge(4, "따뜻하게 눈 찜질해주기", "눈이 뜨끈하게~ 찜질하고 싶대! 오늘 하루 많이 일했으니까 따뜻한 수건으로 찜질해보자", "눈을 찜질하니까 혈액순환이 잘되는 느낌이지? 게다가 피로도 풀려서 좋다구!", 20),
    new Challenge(5, "5초동안 눈을 지그시 누르기", "소중한 눈을 마사지해줘~ 분명 시원할거야! 너무 세게 누르지는 말아줘! 아프면 안돼!", "어때? 시원하지? 눈이 피로가 싹 풀리는 기분이래~ 가끔씩 이렇게 눈 마사지를 해주자!", 20),
    new Challenge(6, "블루 스크린 차단 화면 하기", "파란 빛은 에너지가 강하다구~ 눈이 피로해질 수 있어! 우리 함께 차단해보자!", "파란 빛을 차단해보니까 어때? 조금 어색할 수 있지만 눈을 위해서 가끔씩 이렇게 해보자~", 20),
    new Challenge(7, "화면 밝기 줄여보기", "아이고 눈부셔! 화면 밝기가 너무 밝은 것 같아.. 잠시만 화면 밝기를 낮춰줘~", "이정도도 잘 보이지 않아? 너무 밝게 오랫동안 사용하지 말자! 우리의 눈은 소중하니까~", 20)
  ]),
  new Course(21, 3, "바른생활 어른이", "규칙적인 생활습관으로 더욱 건강한 생활을 해봐! 일주일후엔 자연스럽게 몸에 베어있을거야 ", 7, 20, [
    new Challenge(1, "일정한 시간 정해두고 자고 일어나기", "뒤죽박죽 수면시간은 건강에 좋지 않아. 잠자는 시간을 정해두고 실천해봐 ! 개운하게 아침을 시작할 수 있을거야 !", "너무 많지도 ,적지도 않은 너만의 수면시간을 정해서 앞으로도 실천해봐 ! 너의 몸을 건강하고 가볍게 만들어줄거야 !", 20),
    new Challenge(2, "한끼는 편식하지말고 건강하게 챙겨먹기", "맵고 짜고 단게 맛있지만, 오늘은 영양분이 가득한 식단을 챙겨먹어봐 ! 온몸의 세포들이 깨어나는 기분일거야", "벌써 건강해진 느낌이 들지 않아 ? 편식하지말고 골고루 잘 먹는 사람이 얼마나 보기 좋다고", 20),
    new Challenge(3, "아침에 일어나서 물 한잔 마셔보리기", "상쾌한 아침을 시작하며 물 한 컵 마셔보는 건 어때? 하루의 시작에 힘이 돼줄 거야", "정말 쉬운 일이지? 매일 아침 일어나서 물 한잔 마시면 피부도 건강도 더욱 좋아질거야", 20),
    new Challenge(4, "오늘 밤에는 누워서 핸드폰 하지말기", "매일 밤 너의 곁을 지키는 핸드폰을 잠시 내려놓고 일찍 잠에 들어보자, 눈도 마음도 편해질거야", "깜깜한 밤, 핸드폰에서 나오는 빛은 눈 건강에 무척 안 좋대 ! 자기전 핸드폰은 잠시 접어두고 꿈나라로 가보자", 20),
    new Challenge(5, "나를 위한 Todo list, Stop list 적고 도전하기", "해야 할 일과 안 할 일들을 구분해서 계획을 세우고 알찬 하루를 보내봐 !  스스로에게 뿌듯한 마음이 들거야", "계획을 따라 알차게 하루를 보낸 너에게 아낌없이 박수를 보내 ! 계획을 모두 지키지 못했어도 시작이 반이라는 말처럼 넌 정말 잘하고 있어", 20),
    new Challenge(6, "하루 5번 크게 소리내서 웃기", "소리내서 웃는게 수명을 연장해준다는 이야기 들어봤어 ? 그만큼 웃음은 중요해 ! 오늘은 활짝 웃어보자 :)", "웃을 일이 없어도 의식적으로 웃으면 너의 일상에 절로 웃음꽃이 피어날거야 ! 우하하 지금도 한번 다시 웃어봐 ^^", 20),
    new Challenge(7, "자기전 고생한 나에게 힘이 되는 메세지 적어보기", "자기 자신에게 사랑을 듬뿍 담아서 자기전에 메모를 적어봐 ! 타인이 아닌 나에게 주는 칭찬도 정말 달콤할거야", "스스로에게 메모를 남기는게 어색할 수 있지만 다른 사람들에게 하는 칭찬만큼 너 자신에게도 무한 칭찬을 해줘", 20)
  ]),
  new Course(22, 4, "달라달라", "가벼운 도전으로 일상에 새로운 변화를 줘보자구 ~", 7, 20, [
    ...
    new Challenge(2, "방배치 바꿔보기", "방이 너무 크면 책상 위에 있는 물건도 좋아 ! 새로운 환경에 있으면 우리 기분도 달라진다구 ~", "사실 최근에 책상 위 물건을 정리했는데 ... 테이프가 안보이지 뭐야. 혹시 너가 가져갔어 ?", 20),
    new Challenge(3, "주변 편의점 신메뉴 도전", "새로운 걸 경험한다는 건 항상 설레는 일인 것 같아 ~ ㅁㅁㅁ의 후기가 궁금한걸 ?!", "오늘의 경험이 ㅁㅁㅁ의 하루에 작은 활력이 되었으면 좋겠어 ! 오늘 하루 마무리 잘해 ~", 20),
    new Challenge(4, "새로운 주제의 글 읽어보기", "책도 좋고 짧은 논평이나 기사도 좋아 ! 평소에 손이 잘 가지 않았던 주제로 골라봐 !", "새로운 주제도 도전해보니까 나름 흥미롭지 않아? 견문을 더 넓혀보자구 ~", 20),
    new Challenge(5, "취미생활 찾아보기", "1시간 정도 여유를 내서 평소에 궁금했던 관심사를 찾아봐봐! 새로운 취미를 찾으면 금방 일상이 바뀔걸 ~", "내 취미는 뭐냐고 ? 아잇 비밀이야 ! 더 친해지면 알려줄게 챌린지 열심히 해줘 !", 20),
    new Challenge(6, "향수 바꿔보기", "오늘은 자주 뿌리던 향수 말고 다른 향수를 써보는건 어때? 향수가 없다면 바디워시도 좋아 !", "킁카킁카 이 향 너무 좋다 ! 무슨 향이야? ㅁㅁㅁ 너랑 완전 잘어울려 !", 20),
    new Challenge(7, "명상하기", "챌린지 하느라 정신 없이 시간을 보냈지? 마지막은 명상하면서 바쁜 일상을 탈출해보자고 ! 여유를 즐겨 ~", "색다른걸 해보니까 나의 세상이 더 넓어진 것 같은 기분이지? 성장하는 ㅁㅁㅁ가 대견스럽다구 ~", 20)
  ]),
  new Course(23, 6, "전지적 친구 시점", "친구가 보는 나는 어떤 이미지일까?전지적 친구 시점으로 나를 바라보자!", 3, 20, [
    new Challenge(1, "친구에게 내 첫인상 물어보기", "친구랑 처음 만났을 때 기억나?그 때 친구가 느낀 내 첫인상은 어땠을까?", "진짜? 나는 ㅁㅁㅁ 처음 봤을 때 어땠더라...~", 20),
    new Challenge(2, "나 하면 떠오르는 색 물어보기", "나를 보면 무슨 색이 떠오르는지 물어보자!나는... 무지개색?", "와 너무 좋은 느낌의 색이야~ㅁㅁㅁ! 나를 보면 무슨 색이 떠올라 ?", 20),
    new Challenge(3, "내 가장 좋은 점 물어보기", "조금 낯간지럽지만, 좋아한다는 말은 많이 말 할수록 좋지! 내 어디가 좋아!?", "나도 ㅁㅁㅁ의 그 점이 가장 좋은데!", 20)
  ])
];
